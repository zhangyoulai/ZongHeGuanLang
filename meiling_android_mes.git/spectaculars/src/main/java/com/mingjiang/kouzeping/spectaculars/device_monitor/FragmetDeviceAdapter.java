...
import com.mingjiang.android.equipmonitor.activity.FoamingMachineActivity;
import com.mingjiang.android.equipmonitor.activity.PerfusionMachineActivity;
import com.mingjiang.android.equipmonitor.activity.WeldmentActivity;
...
public class FragmetDeviceAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (color.equals("green")){
            //运行中
            viewHolder.colorTv.setBackgroundResource(R.color.run);
            viewHolder.colorTv.setText("运行中");
        }else if (color.equals("red")){
            //暂停
            viewHolder.colorTv.setBackgroundResource(R.color.not_run);
            viewHolder.colorTv.setText("暂停");
        }else if (color.equals("blue")){
            //待运行
            viewHolder.colorTv.setBackgroundResource(R.color.rb);
            viewHolder.colorTv.setText("待运行");
        }
