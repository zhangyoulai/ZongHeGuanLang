...
import com.mingjiang.android.equipmonitor.activity.LineActivity;
...
public class FragmetDeviceAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView=LayoutInflater.from(mContext).inflate(R.layout.layout_device_item,null);
        ...
        viewHolder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.contains("01")){
                    ...
                    intent = new Intent(mContext,LineActivity.class);
                    intent.putExtra("key","04");
                }
