...
public class ReturnAdapter extends BaseAdapter {
    ...
    public ReturnAdapter(Context context, List<AroundMaterialValue> aroundMaterialValueArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.return_fragment_item, null);
