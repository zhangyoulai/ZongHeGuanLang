...
import com.mingjiang.android.app.adapter.Pol1ValueAdapter;
...
public class FoamingMachineActivity extends Activity {
    ...
    private void defaultData() {
        box1Tv.setText("7286");
        pol1Chart.addEntry("1", (float) Integer.parseInt("7286"));

        box3Tv.setText("192");
        pol2Chart.addEntry("1", (float) Integer.parseInt("192"));

        box5Tv.setText("100");
        pol3Chart.addEntry("1", (float) Integer.parseInt("100"));

        box7Tv.setText("100");
        pol4Chart.addEntry("1", (float) Integer.parseInt("192"));
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0: {
                    ...
                    pol1Chart.addEntry("1", (float)Integer.parseInt(value));
                    break;
                }
                case 1: {
                    Bundle buldler = msg.getData();
                ...
                case 2: {
                    ...
                    pol2Chart.addEntry("1", (float)Integer.parseInt(value));
                    break;
                }
                case 3: {
                    Bundle buldler = msg.getData();
                ...
                case 4: {
                    ...
                    pol3Chart.addEntry("1", (float)Integer.parseInt(value));
                    break;
                }
                case 5: {
                    Bundle buldler = msg.getData();
                ...
                case 6: {
                    ...
                    pol4Chart.addEntry("1", (float)Integer.parseInt(value));
                    break;
                }
                case 7: {
                    Bundle buldler = msg.getData();
