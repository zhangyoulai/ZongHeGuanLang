...
import com.mingjiang.android.app.adapter.MyLineLogInfoAdapter;
...
public class LineLogInfoFragment extends DialogFragment {
    ...
    private void getLineLogInfo() {
        ...
        AppContext.getNetService(mContext).queryLinLogInfo(map).subscribe(new Action1<List<LineLogInfoItem>>() {
            @Override
