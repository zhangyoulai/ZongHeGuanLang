package com.mingjiang.android.app.view;
...
/**
 * Created by Jxin on 2016/2/20.
 * Email:jx0035c.c.42@gmail.com.
 */
public class OpenFileDialog {
    public final static String TAG = "OpenFileDialog";
    ...
    static class FileSelectView extends ListView implements AdapterView.OnItemClickListener {
        ...
        private String getSuffix(String filename) {
            int dix = filename.lastIndexOf(sFolder);
            if (dix < 0) {
                return sEmpty;
            } else {
        ...
        private int refreshFileList() {
            ...
            // 访问出错
            if (files == null) {
                Toast.makeText(getContext(), "访问错误", Toast.LENGTH_LONG).show();
                return -1;
            }
            if (list != null) {
                list.clear();
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.item_grid_dialog,
