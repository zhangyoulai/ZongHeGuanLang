...
//        }
        if (Integer.parseInt(deviceDetail.getProduced_count())>Integer.parseInt(deviceDetail.getOrder_quantity())){
            viewHolder.textView2.setText(deviceDetail.getOrder_quantity());
        }else {
            viewHolder.textView2.setText(deviceDetail.getProduced_count());
        }
