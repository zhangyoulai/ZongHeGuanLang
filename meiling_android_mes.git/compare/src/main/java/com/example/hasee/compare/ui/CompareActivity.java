package com.example.hasee.compare.ui;
...
import com.example.hasee.compare.bean.Code;
import com.example.hasee.compare.bean.CodeAndSpec;
import com.example.hasee.compare.dao.IbDataBaseUtil;
import com.example.hasee.compare.dao.InsertPreparedData;
import com.example.hasee.compare.service.ComService;
import com.example.hasee.compare.utils.HttpClientUtils;
import com.example.hasee.compare.utils.MockDataUtils;
...
public class CompareActivity extends Activity {
    ...
    private void importPlan() {
        new Thread() {
            @Override
            public void run() {
                String url = com.mingjiang.android.base.util.Config.getBaseUrl(CompareActivity.this) + "api/interface/public/plan_manage.daily_plan/process_serial_element";
                items = MockDataUtils.getCodeAndSpec(url);
    ...
    private void commitData() {
        new Thread(){
            ...
            public void run() {
                ...
                String url = com.mingjiang.android.base.util.Config.getBaseUrl(CompareActivity.this) +
                        com.example.hasee.compare.Config.URL_UPLOAD_CODE;
